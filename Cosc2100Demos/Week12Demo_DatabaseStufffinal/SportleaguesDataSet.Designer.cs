...
namespace Week12Demo_DatabaseStufffinal.SportleaguesDataSetTableAdapters {
    ...
    public partial class teamsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[teams] ([teamid], [teamname]) VALUES (@teamid, @teamname);\r\nSE" +
                "LECT teamid, teamname FROM teams WHERE (teamid = @teamid)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[teams] SET [teamid] = @teamid, [teamname] = @teamname WHERE (([teamid] = @Original_teamid) AND ((@IsNull_teamname = 1 AND [teamname] IS NULL) OR ([teamname] = @Original_teamname)));
