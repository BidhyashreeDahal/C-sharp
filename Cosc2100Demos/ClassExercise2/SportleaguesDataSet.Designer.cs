...
namespace ClassExercise2.SportleaguesDataSetTableAdapters {
...
SELECT teamid, teamname, isactive, jerseycolour FROM teams WHERE (teamid = @teamid)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT isactive, jerseycolour, teamid, teamname FROM teams";
        ...
        public virtual int FillBy(SportleaguesDataSet.teamsDataTable dataTable) {
