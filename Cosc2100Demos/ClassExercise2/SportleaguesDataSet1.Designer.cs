...
namespace ClassExercise2 {
    ...
    public partial class SportleaguesDataSet1 : global::System.Data.DataSet {
        ...
        public partial class playersDataTable : global::System.Data.TypedTableBase<playersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public playersRow AddplayersRow(int playerid, string regnumber, int isactive, System.DateTime dob, string fullname, int teamid, string teamname) {
...
namespace ClassExercise2.SportleaguesDataSet1TableAdapters {
    ...
    public partial class playersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = @"SELECT p.playerid, t.teamid, p.regnumber, t.teamname, p.isactive, p.dob, p.firstname + p.lastname AS fullname
FROM   players AS p INNER JOIN
             rosters AS r ON p.playerid = r.playerid INNER JOIN
             teams AS t ON r.teamid = t.teamid
WHERE (t.teamid = @tid)";
            ...
            this._commandCollection[1].CommandText = "SELECT dob, firstname + lastname AS fullname, isactive, playerid, regnumber FROM " +
                "players";
        ...
        public virtual int Fill(SportleaguesDataSet1.playersDataTable dataTable, int tid) {
        ...
        public virtual SportleaguesDataSet1.playersDataTable GetData(int tid) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(tid));
        ...
        public virtual int FillBy(SportleaguesDataSet1.playersDataTable dataTable) {
